...
describe('layoutStore', () => {
  ...
  describe('Layout Management', () => {
    ...
    it('should set current layout', () => {
      const { createLayout, setCurrentLayout, currentLayoutId } = useLayoutStore.getState();
    ...
    it('should delete non-default layout', () => {
      const { createLayout, deleteLayout, layouts } = useLayoutStore.getState();
    ...
    it('should not delete default layout', () => {
      const { deleteLayout, layouts } = useLayoutStore.getState();
  ...
  describe('Utilities', () => {
    ...
    it('should reset to default', () => {
      const { createLayout, resetToDefault, layouts, currentLayoutId } = useLayoutStore.getState();
    ...
    it('should load preset layout', () => {
      const { loadPreset, layouts } = useLayoutStore.getState();
